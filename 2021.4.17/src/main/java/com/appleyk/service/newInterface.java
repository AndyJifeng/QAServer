...
public class newInterface {
    ...
    @PostMapping (value = "/addOneEntityTemplate")
    public void addOneEntityTemplate(@RequestBody String body){
        //System.out.println(body);
        List<Object> list = JSONArray.parseArray(body);
        Templates template = new Templates();
        List<Object> templates = template.OneEntity();
        list = template.addTemplates(list,templates);
        template.writeTemplates("./data/template/OneEntity.txt",list);
    }
    @PostMapping (value = "/addTwoEntityTemplate")
    public void addTwoEntityTemplate(@RequestBody String body){
        //System.out.println(body);
        List<Object> list = JSONArray.parseArray(body);
        Templates template = new Templates();
        List<Object> templates = template.TwoEntity();
